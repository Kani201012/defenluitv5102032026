...
/* =========================================
       2026 ASYMMETRICAL & BENTO LAYOUT ENGINE
       ========================================= */
    ...
    .asym-text-box {
        position: relative;
        width: 50%; /* Overlaps the image intentionally */
        padding: 4rem;
        background: var(--card);
        border-radius: 32px;
        z-index: 5;
    ...
    @media (max-width: 992px) {
        ...
        .asym-text-box {
            width: 90%;
            margin: -80px auto 0 auto; /* Pulls text box up over the image on mobile */
            padding: 2rem;
        }
        .asym-badge {
