...
def generate_modern_css(theme_name, h_font, b_font, hero_align, h_color, b_color, h1_size, p_size, cta_bg, cta_txt):
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    #features .container > div:last-child {{
        ...
        align-items: stretch !important; /* FIX 1: Forces cards to stretch and equal heights */
    }}
    ...
    .modern-feature-card, .bento-card {{
        ...
        height: 100% !important; /* FIX 2: Prevents overlap, forces container to hold text */
    ...
    /* FIX 3: Removed span 2 constraint so all cards form a perfect 3x3 layout */
    /*
